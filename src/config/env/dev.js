module.exports = {
    ...
    API_URL_LOGIN: 'https://dev.accounts.codes/hub/login',
    API_URL_BASE_CLIENT: 'http://localhost:3000',
    API_URL_BASE_SERVER: 'https://hub.dev.leader.codes/api',
    ...
    API_URL_CALENDAR:'https://calendar.dev.leader.codes/api',
