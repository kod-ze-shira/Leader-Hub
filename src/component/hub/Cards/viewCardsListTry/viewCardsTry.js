...
import ViewTaskByCard from './viewTaskByCard';
import ViewDetails from '../../viewDetails/viewDetails';
import './viewCardsTry.css';
import Tries from './tries'

function ViewCardsTry(props) {
    useEffect(() => {
    }, [props.flag])
    ...
    return (
        <>
            ...
            <div id={props.cardFromMap._id + "disappear"}>
                <div className="d-flex flex-row justify-content-between border-title  mx-4 mt-4" >
                    <div className=" d-flex flex-row justify-content-between card-name">
                    ...
                    <div className="d-flex flex-row justify-content-between table-columns">

                        <p className="titleCell">Start</p>

                        <p className="titleCell">End</p>

                        <p className="titleCell">Total</p>

                        <p className="titleCell">Assignee</p>
                        <p className="titleCell">Status</p>
                        <p className="titleCell">Start date</p>
                        <p className="titleCell">Due date</p>
...
export default connect(mapStateToProps, mapDispatchToProps)(ViewCardsTry)