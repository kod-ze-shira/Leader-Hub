        ...
        <>
            ...
            <div className="row mt-2">
                ...
                <div className="col-md-2 col-xs-1 WORKSPACE1"><div className="textstart mt-2">
                    <div className="mt-2"></div>
                    <b onClick={() => { props.addNewWorkspaceToServer(); }}>START WORKSPACE</b></div>
                ...
                <div className="col-md-2 col-xs-1 WORKSPACE1"><div className="textstart mt-2">
                    <div className="mt-2"></div>
                    <b onClick={() => { props.addNewWorkspaceToServer(); }}>START WORKSPACE</b></div></div>
...
const mapDispatchToProps = (dispatch) => {
    return {
        addNewWorkspaceToServer: () => dispatch(actions.setWorkspaceCrud()),
